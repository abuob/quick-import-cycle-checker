...
describe('CycleCheckerUtil', () => {
    ...
    it('should detect a simple cycle and handle subdir', async () => {
        const graphCreator: GraphCreator = GraphCreator.builder()
            ...
            .withDirectoryToCheck(path.join(__dirname, './fixtures/simple-cycle-with-subdir'))
            .build();
    ...
    it('should detect a simple cycle and handle doublequotes gracefully', async () => {
        const graphCreator: GraphCreator = GraphCreator.builder()
            ...
            .withDirectoryToCheck(path.join(__dirname, './fixtures/handle-import-with-doublequotes'))
            .build();
    ...
    it('should detect no cycle', async () => {
        const graphCreator: GraphCreator = GraphCreator.builder()
            ...
            .withDirectoryToCheck(path.join(__dirname, './fixtures/no-cycle-simple'))
            .build();
    ...
    it('should detect no cycle and handle subdir', async () => {
        const graphCreator: GraphCreator = GraphCreator.builder()
            ...
            .withDirectoryToCheck(path.join(__dirname, './fixtures/no-cycle-with-subdir'))
            .build();
    ...
    it('should detect a simple cycle', async () => {
        const graphCreator: GraphCreator = GraphCreator.builder()
            ...
            .withDirectoryToCheck(path.join(__dirname, './fixtures/simple-cycle'))
            .build();
