...
/**
 * Taken from https://github.com/abuob/yanice/blob/master/src/util/promise-queue.ts
 * (c) github.com/abuob, MIT-License
 * (note: Same author as this package. Due to commitment to zero dependencies, the redundancy-approach was taken.)
 *
 */
